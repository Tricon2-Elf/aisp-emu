...
public class AreaAvatarMoveRequestHandler(SharedState state, DirectMapLinkTransitionService directMapLinkTransitionService, ILogger<AreaAvatarMoveRequestHandler> logger) : IPacketHandler, IRequiresAuthenticatedSession
{
