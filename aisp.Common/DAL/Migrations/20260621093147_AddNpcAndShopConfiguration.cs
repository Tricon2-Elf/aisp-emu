...
namespace aisp.Common.DAL.Migrations
{
    ...
    public partial class AddNpcAndShopConfiguration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChannelId = table.Column<int>(
                        type: "INTEGER",
                        nullable: false,
                        defaultValue: -1
                    ),
                    DayPhase = table.Column<int>(
                        type: "INTEGER",
                        nullable: false,
                        defaultValue: -1
                    ),
                    DateStartUtc = table.Column<DateTime>(
                        type: "TEXT",
                        nullable: false,
                        defaultValue: new DateTime(1970, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc)
                    ),
                    DateEndUtc = table.Column<DateTime>(
                        type: "TEXT",
                        nullable: false,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AiPrice = table.Column<long>(
                        type: "INTEGER",
                        nullable: false,
                        defaultValue: 0L
                    ),
                    NicoPrice = table.Column<long>(
                        type: "INTEGER",
                        nullable: false,
                        defaultValue: 0L
                    ),
            ...
            migrationBuilder.CreateIndex(name: "IX_Npcs_ShopId", table: "Npcs", column: "ShopId");
        ...
        {
            migrationBuilder.DropTable(name: "NpcEquipment");
