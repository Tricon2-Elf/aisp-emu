...
namespace aisp.Common.DAL.Migrations
{
    ...
    [Migration("20260906090648_AddQuestTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("aisp.Common.DAL.Entities.CharacterQuestHistory", b =>
                {
                    b.Property<int>("CharacterId")
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("CharacterQuestHistories", (string)null);
                });

            modelBuilder.Entity("aisp.Common.DAL.Entities.CharacterQuestWork", b =>
                {
                    b.Property<int>("CharacterId")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<uint>("RestSec")
                        .HasColumnType("INTEGER");

                    b.Property<DateTime>("StartedAtUtc")
                        .HasColumnType("TEXT");

                    b.Property<ushort>("TargetNow")
                        .HasColumnType("INTEGER");

                    b.Property<ushort>("TargetRequired")
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("CharacterQuestWorks", (string)null);
                });
            ...
            modelBuilder.Entity("aisp.Common.DAL.Entities.Quest", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("AutoStartOnConnect")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(false);

                    b.Property<ushort>("DefaultChapter")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue((ushort)1);

                    b.Property<uint>("DefaultRestSec")
                        .HasColumnType("INTEGER");

                    b.Property<string>("DefaultTargetName")
                        .IsRequired()
                        .HasMaxLength(37)
                        .HasColumnType("TEXT");

                    b.Property<ushort>("DefaultTargetRequired")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue((ushort)1);
            ...
            modelBuilder.Entity("aisp.Common.DAL.Entities.CharacterQuestHistory", b =>
                {
                    ...
                    b.HasOne("aisp.Common.DAL.Entities.Quest", "Quest")
                        .WithMany()
