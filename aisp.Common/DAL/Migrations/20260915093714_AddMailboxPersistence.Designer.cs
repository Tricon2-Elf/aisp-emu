...
namespace aisp.Common.DAL.Migrations
{
    ...
    [Migration("20260915093714_AddMailboxPersistence")]
    partial class AddMailboxPersistence
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("aisp.Common.DAL.Entities.MailMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("SenderCharacterId", "CreatedAtUtc");

                    b.ToTable("MailMessages", (string)null);
                });

            modelBuilder.Entity("aisp.Common.DAL.Entities.MailRecipient", b =>
                {
                    b.Property<long>("MailMessageId")
                        .HasColumnType("INTEGER");

                    b.Property<int>("CharacterId")
                        .HasColumnType("INTEGER");

                    b.Property<byte>("InboxType")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                    ...
                    b.HasKey("MailMessageId", "CharacterId");

                    b.HasIndex("CharacterId", "IsDeleted", "MailMessageId");
            ...
            modelBuilder.Entity("aisp.Common.DAL.Entities.MailRecipient", b =>
                {
                    b.HasOne("aisp.Common.DAL.Entities.MailMessage", "MailMessage")
                        .WithMany("Recipients")
